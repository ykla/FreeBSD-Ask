...
VirtualBox 采用 GNU 通用公共许可证第三版（GNU General Public License version 3，GPLv3）协议开源发布，支持 x86 与 AMD64 架构的硬件辅助虚拟化（Intel VT-x 与 AMD-V）。硬件辅助虚拟化技术使虚拟机可以直接访问部分硬件资源，显著提升虚拟化性能。
