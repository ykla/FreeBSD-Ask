...
>
>It is distributed under the GNU General Public License v2 - see the accompanying COPYING file for more details.（Linux 在 GNU 通用公共许可证 v2 下进行分发——更多有关细节，请参阅随附的 COPYING 文件）
...
>
>Torvalds L. Linux: a Portable Operating System[D/OL]. Helsinki: University of Helsinki, 1997 [2026-04-04]. <https://www.cs.helsinki.fi/u/kutvonen/index_files/linus.pdf>. 论文摘要
