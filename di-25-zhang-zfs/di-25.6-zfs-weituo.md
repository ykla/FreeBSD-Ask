...
- [man zfs-allow](https://openzfs.github.io/openzfs-docs/man/master/8/zfs-allow.8.html) - [zfs-allow  --  delegate ZFS administration permissions to unprivileged users](https://man.freebsd.org/cgi/man.cgi?zfs-allow)
