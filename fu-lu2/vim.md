...
- 第二句 Glaive 语句设置格式化的风格样式。也可以设为 `"file"` 或 `"file:<format_file_path>"`。参考 [格式](https://clang.llvm.org/docs/ClangFormatStyleOptions.html) - 第一句 autocmd 设置在文件为类型是 c/cpp 时启用 vim-codefmt 的 AutoFormatBuffer clang-format。
...
- [asynctasks.vim - 现代化的构建任务系统](https://github.com/skywind3000/asynctasks.vim/blob/master/README-cn.md) ## 最后以最简单的 C++ hello world 项目为例
