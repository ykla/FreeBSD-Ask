...
GhostBSD 的下载地址为 <https://www.ghostbsd.org/download>。GhostBSD 官方仅提供基于 MATE 桌面环境的安装镜像，社区则提供了基于 Xfce 的版本。GhostBSD 是一款滚动发行版，但更新节奏相对缓慢，基于 FreeBSD 最新的 STABLE 分支。常见问题文档在 [FAQ](https://ghostbsd-documentation-portal.readthedocs.io/en/latest/user/FAQ.html) [备份](https://web.archive.org/web/20260117111511/https://ghostbsd-documentation-portal.readthedocs.io/en/latest/user/FAQ.html)。可以看到系统默认未安装编译工具，需要通过命令 `sudo pkg install -g 'GhostBSD*-dev'` 进行安装。
