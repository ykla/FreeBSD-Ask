...
>- 你的 U 盘是否为扩容盘？（假冒伪劣）
> - 你是否使用了 Ventoy 工具？
>   - 建议使用 [Rufus](https://rufus.ie/zh/) 进行刻录，而非 [Ventoy](https://www.ventoy.net/cn/index.html) [备份](https://web.archive.org/web/20260116224411/https://www.ventoy.net/cn/index.html)。
