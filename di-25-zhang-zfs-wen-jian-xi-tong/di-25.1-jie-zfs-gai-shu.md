...
ZFS 于 2005 年 10 月 31 日（太平洋时间，revision 789）以 CDDL（Common Development and Distribution License，通用开发及发行许可）开源至 OpenSolaris 项目中。
...
在 OpenSolaris 关停 3 年后（2013 年），OpenZFS 项目正式成立，统一了 ZFS 的开源开发（此前 ZFS on Linux 项目已于 2008 年启动）。由于 Oracle Solaris ZFS 的闭源开发，OpenZFS 很难再兼容 Oracle Solaris ZFS。
