...
SCTP 是一种传输层协议，最初由 RFC 2960 定义，后由 RFC 3309 和 RFC 3758 更新；2007 年发布的 RFC 4960 取代了 RFC 2960 与 RFC 3309，成为新的基础规范，此后又经 RFC 6096、RFC 7053 等更新；2023 年发布的 RFC 9260 进一步取代了 RFC 4960（IETF. RFC 9260: Stream Control Transmission Protocol[EB/OL]. (2023-06). [2026-04-17]. <https://datatracker.ietf.org/doc/rfc9260/>.）。本版本支持所有扩展，包括许多草案（大部分即将成为 RFC）。它是 SCTP 的参考实现，经过了充分测试。
