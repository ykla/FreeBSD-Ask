...
- [fail2ban does not feed pf table](https://forums.freebsd.org/threads/fail2ban-does-not-feed-pf-table.67798/) - [Fail2ban on FreeBSD drops complete pf firewall rules](https://github.com/fail2ban/fail2ban/issues/1915) 
### IPFILTER (IPF)
