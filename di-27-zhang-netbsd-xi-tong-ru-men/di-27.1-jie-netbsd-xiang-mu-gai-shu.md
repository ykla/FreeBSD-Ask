...
在前述章节介绍 FreeBSD 系统的基础上，本章转向 BSD 家族的另一重要成员 NetBSD。NetBSD 是一个开源、可移植的类 UNIX 操作系统，作为 BSD 家族的重要成员，它起源于 4.3BSD NET/2 和 386BSD，其首个版本 0.8 发布于 1993 年 4 月 20 日（此后也引入了 4.4BSD-Lite 的变更）。
...
- The NetBSD Foundation. NetBSD About[EB/OL]. [2026-04-14]. <https://www.netbsd.org/about/>. NetBSD 项目官方介绍页面，描述项目历史与目标。
