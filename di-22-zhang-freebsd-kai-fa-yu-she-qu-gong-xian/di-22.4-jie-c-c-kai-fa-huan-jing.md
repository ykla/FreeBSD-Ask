...
然后将其中的乱码删除（删至 `<idea-plugin`），重启 CLion 后可正常进入软件。参见：Bug 290663 - devel/jetbrains-clion: fails to start[EB/OL]. [2026-03-26]. <https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=290663>. 记录 CLion 在 FreeBSD 上的启动问题及解决方案。
