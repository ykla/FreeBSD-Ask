...
获取 7.3 -stable 版本源代码的步骤：

```sh
$ cd /usr                                                                  # 切换到 /usr 目录
$ cvs -qd anoncvs@anoncvs.jp.openbsd.org:/cvs checkout -rOPENBSD_7_3 -P src       # 从 OpenBSD anoncvs 仓库检出 OPENBSD_7_3 版本的 src 源代码树
$ cvs -qd anoncvs@anoncvs.jp.openbsd.org:/cvs checkout -rOPENBSD_7_3 -P xenocara  # 从 OpenBSD anoncvs 仓库检出 OPENBSD_7_3 版本的 xenocara 源代码
