...
IPFW 最初由 BSDi（Berkeley Software Design, Inc.）的 Daniel Boulet 编写，当前的 ipfw2 版本则由 Luigi Rizzo 为 FreeBSD 重写。
...
- FreeBSD Foundation. IPFW Overview[EB/OL]. [2026-04-17]. <https://freebsdfoundation.org/wp-content/uploads/2014/05/IPFW-An-Overview.pdf>.
- FreeBSD Project. ipfw -- IP firewall and traffic shaper control program[EB/OL]. [2026-04-17]. <https://man.freebsd.org/cgi/man.cgi?query=ipfw&sektion=8>. IPFW 防火墙管理工具手册页
