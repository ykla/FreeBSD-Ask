...
- FreeBSD Project. pfsync -- packet filter state table sychronisation interface[EB/OL]. [2026-04-14]. <https://man.freebsd.org/cgi/man.cgi?pfsync(4)>. PF 状态同步接口手册页，用于防火墙冗余部署。
...
- The OpenBSD Project. PF FAQ[EB/OL]. [2026-04-14]. <https://www.openbsd.org/faq/pf/>. OpenBSD 官方 PF 常见问题解答，为 PF 功能的权威参考文档。
