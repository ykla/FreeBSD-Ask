...
FreeBSD Project. qjail(8) - Utility for deployment of jail environments[EB/OL]. [2026-04-02]. <https://www.freebsd.org/cgi/man.cgi?query=qjail>. 官方手册提供完整命令参数说明，是 Qjail 使用的重要技术文档。
