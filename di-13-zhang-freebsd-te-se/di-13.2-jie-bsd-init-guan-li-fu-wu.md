...
>**注意**
>
>关键字 `enable`、`disable`、`delete` 最早出现在 13.0-RELEASE，参见 [Add new rc keywords: enable, disable, delete](https://reviews.freebsd.org/D17113) 系统服务安装后默认未启用，以上命令无法直接执行，需要先启用服务。
